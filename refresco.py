...
print("¡Me llamo ALONSO! ¡Pero la gente me llama PROFESOR ALONSOMON!")
print("PROF. ALONSOMON: ¡Éste mundo está habitado por unas criaturas llamadas POKÉMON!")
print("PROF. ALONSOMON: Para algunos, los POKÉMON son mascotas. Pero otros los usan para pelear.")
print("PROF. ALONSOMON: En cuanto a mí... Estudio a los POKÉMON como profesión.")


#Preguntas 1
print("PROF. ALONSOMON: Bueno, cuéntame algo de ti.")
identidad = input("¿Eres chico o chica? ")
while identidad not in ['chico', 'chica']:
    print("Lo siento no entendi bien, porfavor ingresa una opcion valida")
    identidad = input("¿Eres chico o chica? ")
if identidad == "chico":
    print("Oh, bien eres un chico.")
elif identidad == "chica":
    print("Oh, bien eres una chica.")
nombre = input("Ahora dime tu nombre: ")
print("¡Bien!")
print(f'¡Asi que te llamas {nombre}!')
print("PROF. ALONSOMON: Este es mi nieto, Joaquin.")
print("PROF. ALONSOMON: Ha sido tu rival desde que eran pequenos.")
print(f'PROF. ALONSOMON: {nombre}! Tu propia leyenda POKEMON esta a punto de comenzar!')
print("PROF. ALONSOMON: Te espera un mundo de suenos y aventuras con los POKEMON!")
print("Adelante!")


#Toma de decisiones 1
print('*Despiertas en tu cama* Que quieres hacer?')
accion1 = input("Ir con mama (1) o salir de casa (2) ")
...
print("PROF. ALONSOMON: Eh! Alto! No te vayas! Cuidado en la hierba viven POKEMON salvajes! Necesitas a tu propio POKEMON como proteccion! Vente conmigo, anda!")
print("*Llegas al laboratorio del PROF. ALONSOMON*")


#Eleccion Pokemon
print("Joaquin: Abuelo! Estoy harto de esperar!")
print(f'PROF. ALONSOMON: Joaquin? Dejame pensar... Ah, si! Te pedi que vinieras. Espera... {nombre}, toma! Aqui hay 3 POKEMON! Bien! Estan dentro de las POKE BALLS! Cuando yo era joven, era un buen ENTRENADOR de POKEMON! Pero ahora solo me quedan 3. Te dare uno. Cual quieres?')
print("Joaquin: Oye abuelo! Y yo que?")
print("PROF. ALONSOMON: Tranquilo, Joaquin! Te dare otra a ti!")
pokemon = input("Charmander (1) o Squirtle (2) ")
while pokemon not in ['1', '2']:
    print("Lo siento, ingresa una opcion valida.")
    pokemon = input("Charmander (1) o Squirtle (2)  ")
if pokemon == '1':
    print("Asi que CHARMANDER! Pues ten paciencia con el. Ese POKEMON tiene mucha energia.")
else:
    print("Asi que SQUIRTLE! Merece la pena, si, si.")
Npokemon = input("Dale un mote a tu pokemon: ")
print("Joaquin: Pues este para mi!")
print("*Joaquin recibio el BULBASAUR de manos del PROF. ALONSOMON*")
print(f'Joaquin: Espera, {nombre}! Probemos a nuestros POKEMON!')
print("Adelante, luchemos!")

'''
EL PSEUDOCODIGO ES IMPORTANTE

Agarrar datos del cliente

Si los datos no tienen datos en blanco, entonces:
if datos.isblank():
    no_pasa(datos_cliente)
else:
    pasa()
